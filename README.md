...
<ol>
    ...
    <li>
        <a href="./blogs/python/run-script-directly.md">如何直接运行 Python 脚本</a><br><span>Python 3.3+ (Windows) 附带了一个名为 py.exe 的启动器，可以将调用转发到本地（包括虚拟环境）不同版本的 Python ，还可以识别脚本中的 shebang 行。</span>
    </li>
    <li>
